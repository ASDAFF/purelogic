...
<? endif; ?>
	...
	<form name="vk_exhangesettings_form" method="post" action="<?= $currPageUrl ?>">
		...
		<tr class="adm-detail-required-field">
			<td>
				<?= Vk\Helper::getHint(Loc::getMessage("SALE_VK_SETTINGS_EXPORT_SETTING_MANUAL", array(
		...
		<?php if ($exportId && strlen($vkCategorySelector) > 0): ?>
			...
			<tr class="adm-detail-required-field">
				<td>
					<?= Vk\Helper::getHint(Loc::getMessage("SALE_VK_SETTINGS_CATEGORIES_DEFAULT_HELP")) ?>
		...
		<? if ($vk->isActive() && $vk->isActiveById($exportId)): ?>
			...
			<tr>
				<td>
					<?= Vk\Helper::getHint(Loc::getMessage("SALE_VK_SETTINGS_AGRESSIVE_EXPORT_HELP")); ?>
			...
			<tr>
				<td>
					<?= Vk\Helper::getHint(Loc::getMessage("SALE_VK_SETTINGS_EXPORT_TIMELIMIT")) ?>
			...
			<tr>
				<td>
					<?= Vk\Helper::getHint(Loc::getMessage("SALE_VK_SETTINGS_EXPORT_COUNT_ITEMS_HELP")) ?>
