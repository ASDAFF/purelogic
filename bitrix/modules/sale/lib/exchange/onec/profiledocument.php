...
class ProfileDocument extends DocumentImport
{
     ...
     * @return array
     */
    private function resolveRelationArrayParams($value, $fieldsInfo)
    {
        $fields = array();
     ...
     * @return array
     */
    private function resolveArrayParams($value, $fieldsInfo)
    {
        $fields = array();
        $message = self::getMessage();
     ...
     * @return null
     */
    private function resolveFields(array $document, array $fieldsInfo)
    {
        $fields = null;
        $message = self::getMessage();
