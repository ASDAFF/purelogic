...
//		------------------------------
		...
		$resultHtml .= '
			...
			Helper::getHint(Loc::getMessage("SALE_VK_EXPORT_SETTINGS__TO_ALBUM_HELP")) . '
				</td>
			...
			Helper::getHint(Loc::getMessage("SALE_VK_EXPORT_SETTINGS__INCLUDE_CHILDS_HELP")) . '
				</td>
				<td align="left" class="internal-right">' .
			Loc::getMessage("SALE_VK_CATEGORY_SELECTOR") .
			Helper::getHint(Loc::getMessage("SALE_VK_CATEGORY_SELECTOR_HELP")) . '
				</td>
			</tr>';
...
//		not need check  INHERIT and ENABLE. Patamushta not need
		...
		$settings["INCLUDE_CHILDS"] = $_POST['VK_EXPORT'][$exportId]["INCLUDE_CHILDS"] ? true : false;
