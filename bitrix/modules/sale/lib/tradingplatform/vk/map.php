...
class Map
{
	public static function getProductEntityCode($exportId)
	{
		return "VK_PRODUCTS_" . $exportId;
	}
	
	public static function getPhotoEntityCode($exportId)
	{
		return "VK_PHOTOS_" . $exportId;
	}
	
	public static function getAlbumEntityCode($exportId)
	{
		return "VK_ALBUMS_" . $exportId;
	}
	
	public static function getSectionsEntityCode($exportId)
	{
	...
	public static function getProductEntityId($exportId)
	{
	...
	public static function getPhotoEntityId($exportId)
	{
	...
	public static function getAlbumEntityId($exportId)
	{
	...
	public static function getSectionsEntityId($exportId)
	{
