...
if($USER->IsAuthorized() && check_bitrix_sessid())
{
	...
	elseif ($_REQUEST['action'] == 'columnssizes')
	{
		$gridOptions->setColumnsSizes($_REQUEST['expand'], $_REQUEST['columns']);
	}
	elseif ($_REQUEST['action'] == 'pagesize')
	{
		$gridOptions->setPageSize($_REQUEST['pagesize']);
	}
