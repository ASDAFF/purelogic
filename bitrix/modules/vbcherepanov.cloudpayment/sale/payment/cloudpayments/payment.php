...
<?if($arParams['PAYTYPE']=='SM'){
	CModule::IncludeModule("vbcherepanov.cloudpayment");
...
<?}?>
		...
		<?=GetMessage("VBCH_CLOUDPAYMENT_DESCRIPTION")?>
		</td>
	</tr>
	<tr>
		<td colspan="2" style="text-align:justify">
			<?=GetMessage("VBCH_CLOUDPAYMENT_DESCRIPTION1")?>
		</td>
	</tr>
    <tr>
        <td colspan="2">
            <img src="/bitrix/images/vbcherepanov.cloudpayment/vbv.jpg" alt="Verified by Visa" title="Verified by Visa"/>&nbsp;
            <img src="/bitrix/images/vbcherepanov.cloudpayment/msc.jpg" alt="MasterCard Secure Code" title="MasterCard Secure Code"/>&nbsp;
            <img src="/bitrix/images/vbcherepanov.cloudpayment/pci.png" alt="PSI DSS" title="PSI DSS"/>
        </td>
    </tr>
