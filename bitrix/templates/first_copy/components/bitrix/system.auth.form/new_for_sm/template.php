...
<div class="bx-system-auth-form form_vtt2">
<div class="error_yo">
<?
...
<form name="system_auth_form<?=$arResult["RND"]?>" method="post" class="hidden-sm form_author2 hidden-xs" target="_top" action="<?=$arResult["AUTH_URL"]?>">
<?if($arResult["BACKURL"] <> ''):?>
