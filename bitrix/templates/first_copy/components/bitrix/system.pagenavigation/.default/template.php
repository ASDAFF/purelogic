...
<?if($arResult["bDescPageNumbering"] === true):?>
	...
	<?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		<?if($arResult["bSavePage"]):?>
			<li><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]?>"><<</a></li>
	...
	<?while($arResult["nStartPage"] >= $arResult["nEndPage"]):?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li ><span class="active_prod"><?=$NavRecordGroupPrint?></span></li>
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		<li><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>">></a></li>
		<li><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=1">>></a></li>
	<?endif?>
...
<?else:?>
	...
	<?while($arResult["nStartPage"] <= $arResult["nEndPage"]):?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li ><span class="active_prod"><?=$arResult["nStartPage"]?></span></li>
