...
?>
<h3 class="name_section">Статьи</h3>
<?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/articles.php"), false);?>	
...
if($arParams["SHOW_TOP_ELEMENTS"]=="vN")
{
