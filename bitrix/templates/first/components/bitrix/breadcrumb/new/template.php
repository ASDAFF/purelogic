...
for($index = 0; $index < $itemSize; $index++)
{
	...
	$arFilter = array('IBLOCK_ID' =>5,"NAME"=>$title); // выберет потомков без учета активности
  ...
  if ($arSect = $rsSect->GetNext())
   {
       ...
       $cl_go="inside";
	   $arFilter1 = array('IBLOCK_ID' =>5,"SECTION_ID"=>$arSect["ID"],"DEPTH_LEVEL"=>$arSect["DEPTH_LEVEL"]+1); // выберет потомков без учета активности
