		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="col-md-12 padding_0">
					...
					<h3 class="name_section">Предложить улучшение</h3>	
					...
					<form action="#" id="user_form">
						...
						<div class="col-md-12">
							<textarea name="#"  placeholder="Ваше предложение*"></textarea>
						</div>
						<div class="col-md-2 col-sm-3">
							<input type="text" class=" ficha" required value="" placeholder="8M6v9" >
						</div>
